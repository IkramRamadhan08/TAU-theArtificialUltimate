...
use tau_actions::{ExtensionCategoryFilter, OpenBrowser};
...
impl AgentConfiguration {
    ...
    fn add_provider_configuration_view(
        ...
        let configuration_view = provider.configuration_view(
            language_model::ConfigurationViewTargetAgent::TauAgent,
            window,
            cx,
        );
...
impl AgentConfiguration {
    ...
    fn render_provider_configuration_block(
        ...
        let is_zed_provider = provider.id() == TAU_CLOUD_PROVIDER_ID;
    ...
    fn render_provider_configuration_section(
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                "LLM Providers",
                "Add at least one provider to use AI-powered features with TAU's native agent.",
    ...
    fn render_context_servers_section(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                ...
                "All MCP servers connected directly or via a Tau extension.",
                ...
                move |window, cx| {
                    Some(ContextMenu::build(window, cx, |menu, _window, _cx| {
                        menu.entry("Install from Registry", None, {
                            |window, cx| {
                                window.dispatch_action(Box::new(tau_actions::AcpRegistry), cx)
                            }
                        })

...
impl Pane {
    ...
    pub fn close_items(
        ...
        items_to_close.sort_by_key(|item| {
            ...
            // This will cause Tau to expand the content of the currently active item
            //
                        ...
                        if let Some(entry) = single_entry_to_resolve {
                            ...
                            menu = menu
                                ...
                                .when_some(entry_abs_path, |menu, abs_path| {
                                    menu.entry(
                                        "Copy Path",
                                        Some(Box::new(tau_actions::workspace::CopyPath)),
                                ...
                                .when_some(relative_path, |menu, relative_path| {
                                    menu.entry(
                                        "Copy Relative Path",
                                        Some(Box::new(tau_actions::workspace::CopyRelativePath)),
                                ...
                                .when(is_local, |menu| {
                                    menu.when_some(reveal_path, |menu, reveal_path| {
                                        menu.separator().entry(
                                            ...
                                            Some(Box::new(
                                                tau_actions::editor::RevealInFileManager,
                                            )),
    ...
    fn render_tab_bar(&mut self, window: &mut Window, cx: &mut Context<Pane>) -> AnyElement {
        ...
        if self.is_tab_pinned(tab_count) {
            log::warn!(
                ...
                in a comment, to https://github.com/tau-industries/tau/issues/33342",
                self.pinned_tab_count,
                tab_count
            );

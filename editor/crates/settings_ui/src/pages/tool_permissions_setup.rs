...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions only apply to the TAU native agent and do not extend to external agents connected through the Agent Client Protocol (ACP).";

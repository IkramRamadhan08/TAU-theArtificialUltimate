...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/tau.git",
                "https",
                "github.com",
                "/octocat/tau.git",
            ),
            (
                "git@github.com:octocat/tau.git",
                "ssh",
                "github.com",
                "/octocat/tau.git",
            ),
            (
                "org-000000@github.com:octocat/tau.git",
                "ssh",
                "github.com",
                "/octocat/tau.git",
            ),
            (
                "ssh://git@github.com/octocat/tau.git",
                "ssh",
                "github.com",
                "/octocat/tau.git",
            ),
            (
                "file:///path/to/local/tau",
                "file",
                "",
                "/path/to/local/tau",
            ),

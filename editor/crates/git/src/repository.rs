...
fn checkpoint_author_envs() -> HashMap<String, String> {
    HashMap::from_iter([
        ("GIT_AUTHOR_NAME".to_string(), "TAU".to_string()),
        ("GIT_AUTHOR_EMAIL".to_string(), "tau@tau.ai".to_string()),
        ("GIT_COMMITTER_NAME".to_string(), "TAU".to_string()),
        ("GIT_COMMITTER_EMAIL".to_string(), "tau@tau.ai".to_string()),
    ])
}
            ...
            vec![
                Branch {
                    ...
                    most_recent_commit: Some(CommitSummary {
                        ...
                        author_name: SharedString::new_static("TAU"),
                        has_parent: true,
                    })
                },
                Branch {

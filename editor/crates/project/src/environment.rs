...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the Tau CLI.
...
fn set_origin_marker(env: &mut HashMap<String, String>, origin: EnvironmentOrigin) {
    env.insert(TAU_ENVIRONMENT_ORIGIN_MARKER.to_string(), origin.into());
}

const TAU_ENVIRONMENT_ORIGIN_MARKER: &str = "TAU_ENVIRONMENT";

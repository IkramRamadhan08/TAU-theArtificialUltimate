...
mod git_worktrees {
    ...
    fn test_validate_worktree_directory() {
        ...
        // Valid: subdirectory
        assert!(
            worktrees_directory_for_repo(work_dir, ".git/tau-worktrees", PathStyle::Posix).is_ok()
        );
...
mod resolve_worktree_tests {
    ...
    fn test_linked_worktree_short_name() {
        let examples = [
            (
                "/home/bob/tau",
                "/home/bob/worktrees/olivetti/tau",
                Some("olivetti".into()),
            ),
            ("/home/bob/tau", "/home/bob/zed2", Some("zed2".into())),
            (
                "/home/bob/tau",
                "/home/bob/worktrees/tau/selectric",
                Some("selectric".into()),
            ),
            ("/home/bob/tau", "/home/bob/tau", None),
        ];

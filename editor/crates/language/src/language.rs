//! The `language` crate provides a large chunk of Tau's language-related
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in Tau setting and keybind
    /// files
    ...
    /// for settings that should be persisted to Tau's settings file.
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to Tau installation
            //
...
impl LanguageScope {
    ...
    ///
    /// By default, Tau treats as paragraph and comment prefixes as boundaries.
    ...
    ///
    /// By default, Tau treats alphanumeric characters (and '_') as word characters for

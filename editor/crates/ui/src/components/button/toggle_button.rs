                ...
                vec![
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::single_row(
                            ...
                            [
                                ToggleButtonWithIcon::new("First", IconName::AiTau, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Second", IconName::AiTau, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Third", IconName::AiTau, |_, _, _| {}),
                            ],
                        )
                        .selected_index(1)
                        .into_any_element(),
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::two_rows(
                            ...
                            [
                                ToggleButtonWithIcon::new("Fourth", IconName::AiTau, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Fifth", IconName::AiTau, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Sixth", IconName::AiTau, |_, _, _| {}),
                            ],
                        )
                        .selected_index(3)
                        .into_any_element(),

            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new("tau").color(Color::Muted)),
                    )
                    .into_any_element(),
            ),
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "a_very_long_username_that_might_overflow is sharing a project in TAU:",
                        ))
                        .child(
                            Label::new("tau-cloud, tau, edit-prediction-bench, tau.dev")
                                .color(Color::Muted),
                        ),
                    )
                    .into_any_element(),
            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "maxbrunsfeld invited you to join the #tau channel",
                        )),
                    )
                    .into_any_element(),
            ),

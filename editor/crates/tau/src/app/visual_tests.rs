...
//! Visual testing infrastructure for Tau.
//!
//! This module provides utilities for visual regression testing of Tau's UI.
//! It allows capturing screenshots of the real Tau application window and comparing
...
//! cargo test -p tau visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p tau visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Tau subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Tau workspace.
    ///

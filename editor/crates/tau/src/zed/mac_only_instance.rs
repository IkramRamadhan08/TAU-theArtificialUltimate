...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "TAU Editor Dev Instance Running",
        ReleaseChannel::Nightly => "TAU Editor Nightly Instance Running",
        ReleaseChannel::Preview => "TAU Editor Preview Instance Running",
        ReleaseChannel::Stable => "TAU Editor Stable Instance Running",
    }
}

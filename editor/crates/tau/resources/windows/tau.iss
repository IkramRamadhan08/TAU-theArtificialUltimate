...
AppPublisher=TAU
AppPublisherURL=https://github.com/IkramRamadhan08/TAU-theArtificialUltimate
AppSupportURL=https://github.com/IkramRamadhan08/TAU-theArtificialUltimate/issues
AppUpdatesURL=https://github.com/IkramRamadhan08/TAU-theArtificialUltimate/releases
...
[Files]
Source: "{#ResourcesDir}\Tau.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\tau"; ValueType: "string"; ValueData: "URL:tau Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\tau"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\tau\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Tau.exe,1"
Root: HKCU; Subkey: "Software\Classes\tau\shell\open\command"; ValueType: "string"; ValueData: """{app}\Tau.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\tau_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);

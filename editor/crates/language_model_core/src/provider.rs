...
pub const TAU_CLOUD_PROVIDER_ID: LanguageModelProviderId = LanguageModelProviderId::new("tau.dev");
pub const TAU_CLOUD_PROVIDER_NAME: LanguageModelProviderName =
    LanguageModelProviderName::new("TAU");

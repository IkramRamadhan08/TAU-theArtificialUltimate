//! Provides constructs for the TAU app version and release channel.
...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "TAU-Editor-Dev",
        ReleaseChannel::Nightly => "TAU-Editor-Nightly",
        ReleaseChannel::Preview => "TAU-Editor-Preview",
        ReleaseChannel::Stable => "TAU-Editor-Stable",
    }
}

/// The Git commit SHA that TAU was built at.
...
pub enum ReleaseChannel {
    ...
    ///
    /// Used for local debug builds of TAU.
    #[default]
    Dev,
...
mod tests {
    ...
    fn test_docs_url_for_release_channel() {
        assert_eq!(
            ...
            "https://tau.ai/docs/nightly/settings"
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            "https://tau.ai/docs/preview/settings"
        );
        assert_eq!(
            ReleaseChannel::Stable.docs_url("settings"),
            "https://tau.ai/docs/settings"
        );
    }
}

...
impl EditPredictionProvider {
    ...
    pub fn display_name(&self) -> Option<&'static str> {
        match self {
            EditPredictionProvider::Tau => Some("Tau AI"),
...
pub struct EditPredictionSettingsContent {
    ...
    /// Controls whether Tau may collect training data when using Tau's Edit Predictions.
...
/// Controls whether Tau collects training data when using Tau's Edit Predictions.
#[derive(
    Copy,
    Clone,
    Debug,
...
pub enum EditPredictionDataCollectionChoice {
    ...
    #[default]
    Default,
    /// Allow Tau to collect training data from open-source projects.
    Yes,
...
pub struct LanguageSettingsContent {
    ...
    /// Tau's Prettier integration settings.
    ...
    /// when you type '(', Tau will automatically add a closing ')' at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type '(', Tau will automatically surround text with ().
    ///
    /// Default: true
...
#[serde(rename_all = "snake_case")]
pub enum Formatter {
    /// Format files using Tau's Prettier integration (if applicable),
    /// or falling back to formatting via language server.
    #[default]
    Auto,
    /// Do not format code.
    None,
    /// Format code using Tau's Prettier integration.
    Prettier,
...
pub struct LanguageTaskSettingsContent {
    ...
    pub enabled: Option<bool>,
    /// Use LSP tasks over Tau language extension ones.
    /// If no LSP tasks are returned due to error/timeout or regular execution,
    /// Tau language extension tasks will be used instead.
    ///
    /// Other Tau tasks will still be shown:
    /// * Tau task from either of the task config file
    /// * Tau task from history (e.g. one-off task was spawned before)

...
pub struct ProjectSettingsContent {
    ...
    /// Whether to disable all AI features in Tau.
    ///
    /// Default: false
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in Tau.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/tau`, worktrees are
    /// created under `~/code/worktrees/tau/`.
    ///
    ...
    /// - `".git/tau-worktrees"` — `<project>/.git/tau-worktrees/`

...
pub struct KeymapSection {
    ...
    /// documentation](https://tau.ai/docs/key-bindings#contexts) for more details.
    #[serde(default)]
    pub context: String,
        ...
        match KeymapFile::load(
            indoc::indoc! {r#"
                [
                    {
                        "unbind": {
                            "ctrl-a": ["tau::Unbind", "test_keymap_file::StringAction"]
                        }
                    }
                ]
            "#},
            ...
            crate::keymap_file::KeymapFileLoadResult::SomeFailedToLoad {
                ...
                assert!(
                    error_message
                        .0
                        .contains("can't use `\"tau::Unbind\"` as an unbind target.")
                );
            }
            other => panic!("expected SomeFailedToLoad, got {other:?}"),
        }
    ...
    fn keymap_update() {
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                ...
                action_name: "tau::SomeOtherAction",
                context: None,
                action_arguments: None,
            }),
            r#"[
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::add(KeybindUpdateTarget {
                keystrokes: &parse_keystrokes("ctrl-b"),
                action_name: "tau::SomeOtherAction",
                context: Some("Tau > Editor && some_condition = true"),
                action_arguments: Some(r#"{"foo": "bar"}"#),
            }),
            r#"[
                {
                ...
                {
                    "context": "Tau > Editor && some_condition = true",
                    "bindings": {
                        "ctrl-b": [
                            "tau::SomeOtherAction",
                            {
        ...
        check_keymap_update(
            ...
            KeybindUpdateOperation::Replace {
                target: KeybindUpdateTarget {
                    keystrokes: &parse_keystrokes("ctrl-a"),
                    action_name: "tau::SomeNonexistentAction",
                    context: None,
                    action_arguments: None,
                },
                source: KeybindUpdateTarget {

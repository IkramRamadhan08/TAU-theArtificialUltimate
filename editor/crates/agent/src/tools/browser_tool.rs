...
const CHROME_PATHS: &[&str] = &[
    "/home/eightarch/.agent-browser/browsers/chrome-149.0.7827.115/chrome",
];
    ...
    fn run(
        ...
        cx.spawn(async move |_cx| {
            ...
            let chrome = find_chrome().ok_or_else(|| BrowserToolOutput::Error {
                error: "No Chrome/Chromium browser found. Expected at: ~/.agent-browser/browsers/chrome-*/chrome".into(),
            })?;

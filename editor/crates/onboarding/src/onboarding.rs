...
use tau_actions::OpenOnboarding;
...
actions!(
    ...
    [
        ...
        SignIn,
        /// Open the user account in tau.dev while in the onboarding flow.
        OpenAccount,
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .child(
                                        h_flex()
                                            .gap_4()
                                            .child(Vector::square(VectorName::TauLogo, rems(2.5)))
                                            .child(
                                                v_flex()
                                                    .child(
                                                        Headline::new("Welcome to TAU")

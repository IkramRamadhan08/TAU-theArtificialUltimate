...
use crate::{EditPredictionStore, TauPredictUpsell};
...
/// Introduces user to Tau's Edit Prediction feature
pub struct TauPredictModal {
                ...
                onboarding: cx.new(|cx| {
                    EditPredictionOnboarding::new(
                        ...
                        Arc::new({
                            ...
                            move |_window, cx| {
                                TauPredictUpsell::set_dismissed(true, cx);
                                set_edit_prediction_provider(EditPredictionProvider::Tau, cx);
...
impl EventEmitter<DismissEvent> for TauPredictModal {}

impl Focusable for TauPredictModal {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl ModalView for TauPredictModal {
...
impl Render for TauPredictModal {
